        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-5xl font-display">
              Everything you need to go viral globally
            </p>
            <p className="mt-6 text-lg leading-8 text-slate-400">
              Our AI evaluates multiple dimensions of your content to provide actionable insights tailored for TikTok, YouTube Shorts, and Instagram Reels worldwide.
            </p>
          </div>
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div className="group flex flex-col items-start bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.05] p-8 rounded-3xl hover:border-cyan-500/30 transition-all duration-500">
                ...
                <dd className="mt-3 leading-relaxed text-slate-400">
                  We analyze the crucial first 3 seconds of your video to determine if it has the power to stop the scroll and capture attention globally.
                </dd>
              </div>
              <div className="group flex flex-col items-start bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.05] p-8 rounded-3xl hover:border-blue-500/30 transition-all duration-500">
                ...
                <dt className="font-bold text-white text-xl font-display">Global Trend Similarity</dt>
                <dd className="mt-3 leading-relaxed text-slate-400">
                  Compare your content against real-time trending signals across the world to see if you're riding the wave of current social media algorithms.
                </dd>
              </div>
              <div className="group flex flex-col items-start bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.05] p-8 rounded-3xl hover:border-indigo-500/30 transition-all duration-500">
                ...
                <dd className="mt-3 leading-relaxed text-slate-400">
                  Get a detailed report with specific improvement suggestions, optimal posting times for your target region, and the best platform for your video.
                </dd>
              </div>
            </dl>
          </div>
