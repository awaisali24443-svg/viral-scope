...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 relative z-10">
      ...
      <div className="prose prose-invert prose-cyan max-w-none bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-md">
        ...
        <ul className="list-disc pl-6 text-slate-300 mb-4 space-y-2">
          ...
          <li>Users may opt out of personalized advertising by visiting <a href="https://myadcenter.google.com/" target="_blank" rel="noreferrer" className="text-cyan-400 hover:underline">Ads Settings</a>.</li>
        </ul>

        <h2 className="text-2xl font-semibold text-white mt-8 mb-4 font-display">4. YouTube API Services</h2>
        <p className="text-slate-300 mb-4">
          Our application uses YouTube API Services. By using our application, you are agreeing to be bound by the <a href="https://www.youtube.com/t/terms" target="_blank" rel="noreferrer" className="text-cyan-400 hover:underline">YouTube Terms of Service</a> and the <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer" className="text-cyan-400 hover:underline">Google Privacy Policy</a>.
        </p>
